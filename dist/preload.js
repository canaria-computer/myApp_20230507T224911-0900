...
electron__WEBPACK_IMPORTED_MODULE_0__.contextBridge.exposeInMainWorld("NavigationOperator", {
    goBack: () => electron__WEBPACK_IMPORTED_MODULE_0__.ipcRenderer.invoke("NavigationOperator", "goBack"),
});
electron__WEBPACK_IMPORTED_MODULE_0__.contextBridge.exposeInMainWorld("scoringApps", {
    test: async (arg) => {
